...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public static final String USERS_LATITUDE = "users_latitude";
    public static final String USERS_LONGITUDE = "users_longitude";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitude = getIntent().getDoubleExtra(USERS_LATITUDE, -34);
        longitude = getIntent().getDoubleExtra(USERS_LONGITUDE, 151);
